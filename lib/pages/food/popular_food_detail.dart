      ...
      body: Stack(
        children: [
          ...
          Positioned(
           ...
           /* Use state management everytime you want to interact with the user and be
            more dynamic based on user interaction ie in our case GetX- GetBuilder. To
            show screen updates immediately*/
          ...
          Positioned(
              ...
              child: Container(
                padding: EdgeInsets.only(left: Dimensions.width30, right: Dimensions.width30,top: Dimensions.height20),
                  decoration: BoxDecoration(
